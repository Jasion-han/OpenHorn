 ...
 *
 * This module is the SINGLE source of truth for command risk across every
 * runtime that can execute shell commands (sidecar agents and the
 * server-side agent). A second, weaker copy of this logic is exactly how
 * the server ended up default-allowing `cat ~/.ssh/id_rsa` — keep it here.
 */
