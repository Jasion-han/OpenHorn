import { Bot, CornerDownLeft, LoaderCircle, MessageSquare, SendHorizontal } from "lucide-react";
...
export function DesktopComposer({
  ...
  return (
    <div className="border-t border-border/50 px-4 py-4">
      <div className="rounded-[24px] border border-border/60 bg-background/85 p-3 shadow-sm">
        ...
        <Textarea
          ...
          rows={4}
          className="min-h-[112px] resize-none border-0 bg-transparent px-0 shadow-none focus-visible:ring-0"
          onKeyDown={(event) => {
