...
### Package: sidecar (`spec/sidecar/`)

- Backend guidelines: `.trellis/spec/sidecar/backend/`

- Frontend guidelines: `.trellis/spec/sidecar/frontend/`
